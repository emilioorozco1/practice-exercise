...
public class ClsWebElements
{
    ...
    public WebElement getGetWebElement(By by)
    {
        try
        {
            ClsReport.fnLog(Status.INFO, "Step - Get Web Element: " + by.toString(), false); //Change Status.INFORMATION to Status.INFO
    ...
    public boolean SendKeys(final By by, String pValue)
    {
        ...
        //return null; Unnecessary code
    }

    public boolean SendKeys(final String pstrLocator, String pValue)
    {
        return SendKeys(By.xpath(pstrLocator), pValue); //Xpaths corrected to xpath
    }
